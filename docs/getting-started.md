...
![ここに画像: Windows 10 でファイル名拡張子を表示する手順](images/STEP01-show-extensions-win10.png)
...
![ここに画像: インストール完了画面](images/STEP04-install-done.png)
...
![ここに画像: ZIP ファイルの展開手順](images/STEP04-extract-zip.png)
...
![ここに画像: VRM ファイルを models フォルダに配置した状態](images/STEP05-place-vrm.png)
...
![ここに画像: メモ帳の「名前を付けて保存」ダイアログ](images/STEP06-create-config.png)
...
![ここに画像: %APPDATA%\Claude\ を開いた状態](images/STEP07-appdata-claude.png)
...
![ここに画像: claude_desktop_config.json の記入例](images/STEP07-mcp-config.png)
